...
<body>
    ...
    <div class="nav">
        ...
        <a href="{{ route('desarrollo.academico') }}">CURSOS</a>
        <a href="{{ route('desarrollo.constancias') }}">CONSTANCIAS</a>
    </div>
    <div class="curso-container">
        ...
        <div class="botones">
            ...
            <button class="boton salir" onclick="location.href='publicacionDeCursosDesarrolloAcademico.html'">➜ SALIR</button>
        </div>        
    </div>
